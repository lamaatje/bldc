...
#define LED_GREEN_ON()			palSetPad(GPIOC, 13)
#define LED_GREEN_OFF()			palClearPad(GPIOC, 13)
#define LED_RED_ON()			palSetPad(GPIOC, 14)
#define LED_RED_OFF()			palClearPad(GPIOC, 14)
